...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="James Craft Beers Spirit Brewers Meet Store Tours"/>
        ...
        <main id="main" role="main">
            <section class="contactInfo">
                <div class="contactInfo__background grid width">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2484.425843209453!2d0.06311141576921647!3d51.487052479631785!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8a8e96b617f95%3A0x21306258871f3fb9!2sWoolwich%20New%20Rd%2C%20Woolwich%2C%20London!5e0!3m2!1sen!2suk!4v1591894617476!5m2!1sen!2suk" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                    <div class="contactInfo__container grid">
                        <div class="contactInfo__intro">
                            <h1>James Fine Spirit</h1>
                            <p>We would love to know what you think of the store, so please get in touch, and if you are nearby, why not pop in to see us? We would love to meet you for a beer!</p>
                        </div>
                        <div class="contactInfo__address">
                            <address>
                                South-East London Craft Beers & Spirits <br>
                                Woolwich New Rd  <br>
                                Woolwich, London  <br>
                                Greenwich, SE18 6EU
                            </address>
                        ...
                        <div class="contactInfo__hours">
                            ...
                            <p>Saturday - Sunday: 09.00 - 9.00 PM</p>
                            <p>Sunday - Closed.</p>
                        </div>
            ...
            <section class="brewery">
                <div class="brewery__images grid">
                    <img src="images/brewery-bartender.png" alt="picture of a bartender">
                    <img src="images/brewery-barrels.png" alt="picture of barrels">
                    <img src="images/brown-wooden-barrel.jpg" alt="picture of wooden barrels">
                    <img src="images/brewery-machine.png" alt="picture of brewery machine">
                    <img src="images/alcohol-barrel-basement-beer.jpg" alt="picture of a barrel in basement">
                    <img src="images/craft-beer-bottles.png" alt="picture of craft beer bottles">
                </div>
                <div class="brewery__background grid width">
                    <div class="brewery__bookTours">
                        <h2>MEET OUR BREWERS AND HAVE A LOOK AROUND.</h2>
                        <a href="#">Book a Tour</a>
                    </div>
                    <div class="brewery__tourInfo">
                        <h3>Brewery tours</h3>
                        <p>Come and see how we brew things around here. How the Brewhouse runs. You can try some beers, grab some merch and take a few tints for later. One condition you book in advance.</p>
                        <h4>Your Tour Includes</h4>
                        <p>A bunch of beer in our tasting room, a tour around our brew house to try the freshest beer straight from the tank, and a few pints on us afterwards.</p>
                    </div>
                </div>
            </section>
