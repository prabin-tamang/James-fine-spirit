    ...
    <div class="navigation">
        <div class="navigation__container flex flex-jc-sb flex-ai-c width">
            ...
            <nav class="navigation__desktopNav" role="navigation">
                <ul>
                    <li class="navigation__link"><a href="index.php">Home</a><span>What's in our home</span></li>
                    ...
                    <li class="navigation__link current"><a href="gallery.php">Gallery</a><span>We love to enjoy</span></li>
                </ul>
            </nav>
