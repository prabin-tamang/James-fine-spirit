<header class="header" role="banner">
    ...
    <div class="navigation">
        <div class="navigation__container flex flex-jc-sb flex-ai-c width">
            ...
            <nav class="navigation__desktopNav" role="navigation">
                <ul>
                    ...
                    <li class="navigation__link"><a href="products.php">Products</a><span>Discover Beers</span></li>
                    <li class="navigation__link"><a href="find-us.php">Find Us</a><span>Have a Beer With Us</span></li>
        ...
        <div class="header__mobile has-fade">
            <nav>
                <ul>
    ...
    <div class="hero">
        <div class="hero__content width">
            <h1><span>Great tasting,</span> 
                hand crafted craft beers.
            </h1>
            <p>We are on a mission to make other people as passionate about great craft beer as we are.</p>
            <a href="products.php">Meet the Beers</a>
            <a href="find-us.php">Learn More</a>
        </div>
        <div class="hero__info">
            <div class="hero__container grid width">
                <span>3 unique sort of craft beer</span>
                <span>Highest quality ingredients</span>
                <span>Soft and purified water used</span>
                <span>new and modern equipments</span>
            </div>
        </div>
    </div>
</header>